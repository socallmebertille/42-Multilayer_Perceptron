...
run_test "train categorical" false $EXEC --dataset datasets/train_set.csv --layer 2 2 --epochs 1 --batch_size 2 --loss categoricalCrossentropy
run_test "train binary" false $EXEC --dataset datasets/train_set.csv --layer 2 2 --epochs 1 --batch_size 2 --loss binaryCrossentropy
